...
- [ ] Publish the evidence-only report/work-item update, pass fresh CI for that exact documentation head, and finish the Lavish implementation ownership loop.
