> **Supersession:** The Pi/HAT evidence and protected harness requirements remain research input. The Nano/MCP251863 actuator conclusion is superseded by STM32G431 native FDCAN with TCAN1044AV-Q1. Logical CAN roles are configured names, not fixed can0/can1 assumptions.
