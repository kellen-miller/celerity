> **Supersession:** The production v1 model family is a compact causal multi-output TCN exported as fixed-shape ONNX and evaluated synchronously with tract. The older ARX, shadow, and human-promotion conclusions below are retained only as research history.
